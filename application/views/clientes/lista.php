            ...
            $(clientes).each(function () {
                $("tbody").append(`
                    <tr id="cliente-${this.id}">
                        ...
                        <td>${this.email}</td>
                        <td>
                            <a data-toggle="tooltip" data-placement="bottom" title="Editar" href="<?php echo site_url("clientes/editar"); ?>/${this.id}" class="btn btn-warning btn-sm btn-tr" role="button"><i class="fas fa-edit"></i></a>
