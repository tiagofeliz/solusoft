            ...
            $(pedidos).each(function () {
                $("tbody").append(`
                    <tr id="pedido-${this.id}">
                        ...
                        <td>
                            <a data-toggle="tooltip" data-placement="bottom" title="PDF" href="<?php echo site_url("pedidos/imprimirPedido"); ?>/${this.id}" class="btn btn-danger btn-sm btn-tr" role="button" target="blank"><i class="fas fa-file-pdf"></i></a>
                            <button data-toggle="tooltip" data-placement="bottom" title="Eviar e-mail" onclick="confirmarEnvio(${this.id})" class="btn btn-secondary btn-sm btn-tr" role="button"><i class="fas fa-paper-plane"></i></button>
                            <a data-toggle="tooltip" data-placement="bottom" title="Detalhes" href="<?php echo site_url("pedidos/detalhes"); ?>/${this.id}" class="btn btn-info btn-sm btn-tr" role="button" target="blank"><i class="fas fa-eye"></i></a>
                            <a data-toggle="tooltip" data-placement="bottom" title="Editar" href="<?php echo site_url("pedidos/editar"); ?>/${this.id}" class="btn btn-warning btn-sm btn-tr" role="button"><i class="fas fa-edit"></i></a>
                            <button data-toggle="tooltip" data-placement="bottom" title="Remover" type="button" onclick="confirmarRemocao(${this.id})" class="btn btn-danger btn-sm btn-tr" role="button"><i class="fas fa-times-circle"></i></a>
                        </td>
                    </tr>
                `);
